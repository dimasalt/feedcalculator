    ...
    <>
      <div className="fixed z-10 overflow-y-auto top-0 w-full left-0 hidden" id="removeModal">
        <div className="flex items-center justify-center min-height-100vh pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          <div className="inline-block align-center bg-red-800 text-white font-light text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            ...
            <div className="bg-gray-200 px-4 py-3 text-right">
              <button type="button" className="py-2 px-5 bg-red-800 text-white font-semibold me-2 shadow-sm shadow-gray-500" onClick={toggleModal}>
                <i className="bi bi-x-circle text-white me-1"></i> 
                Cancel
              </button>
              <button type="button" className="py-2 px-5 bg-green-800 text-white font-semibold me-2 shadow-sm shadow-gray-500" onClick={() => removeFeed()}>
